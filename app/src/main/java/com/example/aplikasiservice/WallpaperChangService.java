...
public class WallpaperChangService extends Service implements Runnable {
    private int wallpaperId[] = {R.drawable.bunga1, R.drawable.bunga2};
    private int waktu;
    private int FLAG = 0;
    private Thread t;
    ...
    public int onStartCommand(Intent intent, int flag, int startId) {
        ...
        t = new Thread(WallpaperChangService.this);
        t.start();
